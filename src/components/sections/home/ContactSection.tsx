    ...
    <section id="contacto" className="section-padding bg-[#040404]">
      <div className="container-custom grid gap-10 lg:grid-cols-[1.1fr,0.9fr]">
        ...
        <motion.div
          ...
          className="relative overflow-hidden rounded-[34px] border border-white/10 bg-gradient-to-br from-white/5 via-transparent to-transparent p-[3px]"
        >
          <div className="relative overflow-hidden rounded-[30px]">
            ...
            <div className="absolute bottom-6 left-6 right-6 text-left text-white/80">
              <p className="text-xs uppercase tracking-[0.4em] text-brand-300">
                Operaciones Globales
              </p>
              <p className="mt-2 text-base font-semibold">
                Gestión integral de transporte y entregas en cada punto de la cadena.
              </p>
            </div>
          </div>
        </motion.div>
